...
def test_disease_gene_example_hetmat_archiving(tmpdir):
    ...
    hetmat = hetmech.hetmat.hetmat_from_graph(graph, hetmat_0_dir)

    # Test creating archive
    archive_path = hetmech.hetmat.archive.create_hetmat_archive(hetmat)
    ...
    hetmech.hetmat.archive.load_archive(archive_path, hetmat_1_dir)
