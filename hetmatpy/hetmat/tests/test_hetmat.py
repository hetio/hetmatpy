...
def test_disease_gene_example_conversion_to_hetmat(tmpdir):
    ...
    hetio_adj = hetmatpy.matrix.metaedge_to_adjacency_matrix(graph, 'GaD', dense_threshold=0)
    ...
    hetio_adj = hetmatpy.matrix.metaedge_to_adjacency_matrix(graph, 'DaG', dense_threshold=0)
